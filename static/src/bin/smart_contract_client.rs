...
fn call_get_limits(transport_handle: &mut  HttpHandle, pair: &Keypair) {
    let message_body = ABICall::<(), (Vec<u8>, i8)>::encode_secret_function_call_into_slice("getLimits", (), pair);
...
fn call_create_limit(transport_handle: &mut  HttpHandle, parameters: Vec<String>, pair: &Keypair) {
    ...
    let message_body = ABICall::<(u8, Duint, Bitstring), (u8, i8)>::encode_secret_function_call_into_slice("createLimit", (limit_type, value, meta), pair);
...
fn call_remove_limit(transport_handle: &mut  HttpHandle, parameters: Vec<String>, pair: &Keypair) {
    ...
    let message_body = ABICall::<(u8,), (i8,)>::encode_secret_function_call_into_slice("removeLimit", (limit_id,), pair);
...
fn call_change_limit(transport_handle: &mut  HttpHandle, parameters: Vec<String>, pair: &Keypair) {
    ...
    let message_body = ABICall::<(u8, Duint, Bitstring), (i8,)>::encode_secret_function_call_into_slice("changeLimitById", (limit_id, value, meta), pair);
...
fn call_send_transaction(transport_handle: &mut  HttpHandle, parameters: Vec<String>, pair: &Keypair) {
    ...
    let message_body = ABICall::<(Bits256, Duint), (i8,)>::encode_secret_function_call_into_slice("sendTransaction", (bits_recipient.into(), value), pair);
...
fn call_get_balance(transport_handle: &mut  HttpHandle, pair: &Keypair) {
    ...
    let message_body = ABICall::<(), (u64,)>::encode_secret_function_call_into_slice("getBalance", (), pair);
