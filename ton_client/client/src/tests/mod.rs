...
#[test]
fn test_tvm_get() {
    let logcfg = "/Users/michaelvlasov/Downloads/log_cfg.yml";
    log4rs::init_file(logcfg, Default::default())
        .expect(&format!("Cannot read logging configuration from {}", logcfg));
