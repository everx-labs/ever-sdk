...
fn math() {
    ...
    let result: ResultOfFactorize = client.request(
        "crypto.factorize",
        ParamsOfFactorize {
...
fn keys() {
    ...
    let result: ResultOfSign = client.request(
        "crypto.sign",
        ParamsOfSign {
...
fn scrypt() {
    ...
    let result: ResultOfScrypt = client.request(
        "crypto.scrypt",
        ParamsOfScrypt {
...
fn nacl() {
    ...
    let result: ResultOfNaclBox = client.request(
        "crypto.nacl_box",
        ParamsOfNaclBox {
...
fn mnemonic() {
    ...
    let result: ResultOfMnemonicVerify = client.request(
        "crypto.mnemonic_verify",
        ParamsOfMnemonicVerify {
            phrase: "one two".into(),
            dictionary: None,
...
fn hdkey() {
    ...
    let result: ResultOfHDKeyPublicFromXPrv = client.request(
    ...
    let child: ResultOfHDKeyDeriveFromXPrv = client.request(
    ...
    let second: ResultOfHDKeyDeriveFromXPrvPath = client.request(
