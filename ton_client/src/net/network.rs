...
impl NetworkContext {
    ...
    pub(crate) async fn get_current_network_uid(&self) -> ever_block::Result<Arc<NetworkUID>> {
    ...
    pub(crate) async fn query_current_network_uid(&self) -> ever_block::Result<Arc<NetworkUID>> {
        let blocks = self
