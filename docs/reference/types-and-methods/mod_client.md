...
* `server_address`?: _string_ – **This field is deprecated, but left for backward-compatibility.**&#x20;
* `endpoints`?: _string\[]_ – List of GraphQL endpoints.\
  Any correct URL format can be specified, including IP addresses. This parameter is prevailing over `server_address`.\
  Check the full list of [supported network endpoints](../ton-os-api/networks.md).
* `network_retries_count`?: _number_ – **This field is deprecated, but left for backward-compatibility.**\
