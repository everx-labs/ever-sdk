...
const USAGE: &str = r#"
Usage:  evercli [OPTIONS] <command> [args...]
...
Example:
    evercli request client.version
    evercli request crypto.generate_random_bytes { length: 32 }
    evercli request abi.attach_signature_to_message_body { \
