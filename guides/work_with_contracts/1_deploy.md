...
* [Deploy steps](1_deploy.md#deploy-steps)
* [Observe deploy parameters](1_deploy.md#observe-deploy-parameters)
* [Prepare a pair of keys](1_deploy.md#prepare-a-pair-of-keys)
* [\[Optional\] Prepare initial contract data](1_deploy.md#optional-prepare-initial-contract-data)
* [Specify constructor](1_deploy.md#specify-constructor)
* [Calculate the future contract address](1_deploy.md#calculate-the-future-contract-address)
* [Transfer funds to the future address](1_deploy.md#transfer-funds-to-the-future-address)
* [Deploy](1_deploy.md#deploy-1)
  * [Pattern 1. Deploy in 1 step: `process_message` method](1_deploy.md#pattern-1-deploy-in-1-step-process_message-method)
  * [Pattern 2. Deploy in 3 steps: `encode_message` -&gt;  `send_message` -&gt; `wait_for_transaction`](1_deploy.md#pattern-2-deploy-in-3-steps-encode_message----send_message---wait_for_transaction)
* [Deploy a contract from another contract](1_deploy.md#deploy-a-contract-from-another-contract)
* [Sample Source Code](1_deploy.md#sample-source-code)
...
[https://github.com/tonlabs/sdk-samples/blob/master/core-examples/node-js/hello-wallet/index\_pattern2.js](https://github.com/tonlabs/sdk-samples/blob/master/core-examples/node-js/hello-wallet/index_pattern2.js)
...
* You can use SDK function [get\_code\_from\_tvc](../../docs/mod_boc.md#get_code_from_tvc) of `boc` module and retrieve the code's boc from tvc file. 
* You can download another account with the same `code_hash`'s `boc` from graphql, using [query\_collection](../queries_and_subscriptions/1_query_collection.md) method and parse it with [parse\_account](../../docs/mod_boc.md#parse_account) function to retrieve the 'code' from the result \(function will return the same JSON account object as graphql\). 
